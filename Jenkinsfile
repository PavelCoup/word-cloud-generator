    ...
    stages {
        ...
        stage('tests') {
            environment {
                ...
                NEXUS_CURL = "curl -u ${NEXUS_CREDS} -X GET http://127.0.0.1:8081/repository/word-cloud-generator/1/word-cloud-generator/1.${BUILD_NUMBER}/word-cloud-generator-1.${BUILD_NUMBER}.gz -O"
