pipeline {
    ...
    //    }        
        ...
        stage('upload nexus') {
            steps {
                sh "curl --fail -u admin:admin --upload-file /go/word-cloud-generator/artifacts/linux/word-cloud-generator.gz 'http://nexus:8081/repository/word-cloud-generator/'"
